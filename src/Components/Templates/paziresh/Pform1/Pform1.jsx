...
import styles from "./Pform1.module.css";
...
export default function Pform1({ nextTab, setContent, setCoustomer }) {
        ...
        try {
          ...
          if (idForm) {
            response = await axios.put(
              `${apiUrl}/app/fill-customer-form/${idForm}`,
              values
            );
          } else {
            response = await axios.post(
              `${apiUrl}/app/fill-customer-form/`,
              values
            );
          }
  ...
  return (
    <>
      <div className={styles.form1_container}>
        <Box sx={{ width: "100%" }}>
          <Tabs
            value={value}
          ...
          <TabPanel value={value} index={0} className={styles.tab1_pform1}>
            <form onSubmit={formik.handleSubmit}>
              <div className={styles.p_form1_contant}>
                <div className={styles.p_form1_row}>
          ...
          <TabPanel value={value} index={1} className={styles.tab1_pform1}>
              ...
              <div className="p-fomrm1-tab2-wrapper">
                  ...
                  <Col xs={12} md={5} className="p-form1-contant-tab2-left">
                    <Col className="tab2-left-item mb-4 mb-md-0">
                      <Input
                        ...
                        value={toFarsiNumber(
                          formik2.values.company_phone_number
                        )}
                        onChange={(e) => {
                          const englishNumber = toEnglishNumber(e.target.value);
                          formik2.setFieldValue(
                ...
                <div className="co-row mt-md-4">
                  ...
                  <Col
                    xs={12}
                    md={5}
                    className="p-form1-contant-tab2-left mb-4 mb-md-0"
                  >
                    <Col xs={12} md={6} className="tab2-left-item">
                      <span
                        style={{ marginRight: "8px" }}
                        className="title-item-form mb-2"
                      >
                        نحوه نوبت دهی :
                      </span>
                      <DropDown
                    ...
                    <div className="p-form1-row mt-4">
                      <Col className="mb-4 mb-md-0" xs={12} md={6}>
                        <Input
                          ...
                          value={toFarsiNumber(
                            formik2.values.national_code_bearer
                          )}
                          onChange={(e) => {
                            const englishNumber = toEnglishNumber(
                              e.target.value
                      ...
                      <Col className="mb-4 mb-md-0" xs={12} md={6}>
                        <Input
                          ...
                          name="phone_number_bearer"
                          value={toFarsiNumber(
                            formik2.values.phone_number_bearer
                          )}
                          onChange={(e) => {
                            const englishNumber = toEnglishNumber(
                              e.target.value
