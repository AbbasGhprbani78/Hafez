...
export default function CodeCar({ name, value, setFieldValue }) {
  ...
  return (
    <div
      className={`${styles.inputs_wrapper} mb-3`}
      style={{ direction: "ltr" }}
    >
      <div
        className={`d-flex align-items-center justify-content-between ${styles.codecar_itemes}`}
      >
        <div
      ...
      <p className={`${styles.code_car} ${styles.title_item_form}`}> شماره پلاک</p>
    </div>
  );
}
